...
const menu = computed(() => [
  ...
  { id: 'misordenes', icono: 'tickets', nombre: 'Mis órdenes', total: porRecibir.value.length },
  { id: 'curso', icono: 'mantenimiento', nombre: 'Trabajos en curso', total: trabajosCurso.value.length },
  { id: 'cotizaciones', icono: 'compras', nombre: 'Cotizaciones y requerimientos', total: porCotizar.value.length },
  { id: 'trabajo', icono: 'editar', nombre: 'Trabajos y anotaciones', total: porIntervenir.value.length },
  { id: 'informes', icono: 'reporte', nombre: 'Pruebas e informes', total: porProbar.value.length },
  { id: 'compras', icono: 'reloj', nombre: 'Seguimiento de compras', total: esperandoCompra.value.length },
  { id: 'notificaciones', icono: 'notificaciones', nombre: 'Notificaciones', total: notificacionesPendientes.value },
