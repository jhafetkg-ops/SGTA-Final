...
const menu = computed(() => [
  ...
  { id: 'desembolso', icono: 'compras', nombre: 'Desembolsar dinero', total: porDesembolsar.value.length },
  { id: 'historial', icono: 'historial', nombre: 'Historial', total: desembolsados.value.length },
])
